...
{BYellow}[{BWhite}1{BYellow}]{BPurple} - info acc
{BYellow}[{BWhite}2{BYellow}]{BPurple} - get following
{BYellow}[{BWhite}3{BYellow}]{BPurple} - get followers 

     
''')
c=int(input(f'{BYellow}[{BWhite}+{BYellow}]{BCayn} - Choose : {BWhite}'))
user = input(f'{BYellow}[{BWhite}+{BYellow}]{BCayn} - username : {BWhite}')
pas=input(f'{BYellow}[{BWhite}+{BYellow}]{BCayn} - password : {BWhite}')
...
def info(u):
  ...
  print('\n'*19)
  try:
    print(f'{BYellow}[{BWhite}+{BYellow}]{BWhite} status : {BCayn}'+req.json()['status'])
  except :
    print(f'{BYellow}[{BWhite}+{BYellow}]{BRed} user not found')
  print('')
  sleep(0.2)
  print(f'{BYellow}[{BWhite}+{BYellow}]{BWhite} user : {BCayn}'+u)
  print('')
  sleep(0.2)
  
  print(f'{BYellow}[{BWhite}+{BYellow}]{BWhite} bio : {BCayn}'+req.json()['data']['user']['biography'])
  print('')
  sleep(0.2)
  print(f'{BYellow}[{BWhite}+{BYellow}]{BWhite} link : {BCayn} '+str(req.json()['data']['user']['external_url']))
  print('')
  sleep(0.2)
  print(f'{BYellow}[{BWhite}+{BYellow}]{BWhite} following : {BCayn} '+str(req.json()['data']['user']['edge_followed_by']['count']))
  print('')
  sleep(0.2)
  print(f'{BYellow}[{BWhite}+{BYellow}]{BWhite} followers : {BCayn} '+str(req.json()['data']['user']['edge_follow']['count']))
  print('')
  sleep(0.2)
  print(f'{BYellow}[{BWhite}+{BYellow}]{BWhite} name : {BCayn} '+str(req.json()['data']['user']['full_name']))
  print('')
  sleep(0.2)
  print(f'{BYellow}[{BWhite}+{BYellow}]{BWhite} id : {BCayn}'+str(req.json()['data']['user']['id']))
  print('')
  sleep(0.2)
  a=str(req.json()['data']['user']['is_business_account'])
  print(f'{BYellow}[{BWhite}+{BYellow}]{BWhite} business account : {BYellow} '+a)
  print('')
  sleep(0.2)
  if a == 'True' :
    print('')
    sleep(0.2)
    print(f'{BYellow}[{BWhite}+{BYellow}]{BWhite} name business : {BYellow}'+str(req.json()['data']['user']['category_name']))
  else:
    pass
  print('')
  sleep(0.2)
  print(f'{BYellow}[{BWhite}+{BYellow}]{BWhite} business email : {BYellow} '+str(req.json()['data']['user']['business_email']))
  print('')
  sleep(0.2)
  print(f'{BYellow}[{BWhite}+{BYellow}]{BWhite} business number : {BYellow} '+str(req.json()['data']['user']['business_phone_number']))
  print('')
  sleep(0.2)
  print(f'{BYellow}[{BWhite}+{BYellow}]{BWhite} private : {BYellow} '+str(req.json()['data']['user']['is_private']))
  print('')
  #sleep(2)
  #print('========not important==========')
  print('')
  sleep(0.2)
  print(f'{BYellow}[{BWhite}+{BYellow}]{BWhite} fbid : {BCayn} '+str(req.json()['data']['user']['fbid']))
  print('')
  sleep(0.2)
  print(f'{BYellow}[{BWhite}+{BYellow}]{BWhite} verified : {BYellow} '+str(req.json()['data']['user']['is_verified']))
  print('')
  sleep(0.2)
  print(f'{BYellow}[{BWhite}+{BYellow}]{BWhite} clips : {BYellow} '+str(req.json()['data']['user']['has_clips']))
if c==1:
  u=input(f'{BYellow}[{BWhite}+{BYellow}]{BCayn} - username target :{BWhite}')
  info(u)
...
def get_ing():
  ...
  print(f'{BYellow}[{BWhite}+{BYellow}]{BCayn} - id : {BWhite}'+id)
  lis=int(input(f'{BYellow}[{BWhite}+{BYellow}]{BCayn} - number of following : {BWhite} '))
  ...
  for i in range(1,lis):
      try:
          ...
          c=b.split(':"')[1]
          #b=str(a.split('","')[0])
          print(f'{BYellow}[{BWhite}{i}{BYellow}]{BCayn} - username : {BWhite}'+c)
      except:
          print('[-] we finished ' )
if c==2:
  get_ing()
...
def get_ers():
  ...
  req=requests.get(ur,headers=header)
  id = str(req.json()['data']['user']['id'])
  print(f'{BYellow}[{BWhite}+{BYellow}]{BWhite} - id : '+id)
  lis=int(input(f'{BYellow}[{BWhite}+{BYellow}]{BCayn} - number of followers : {BWhite}'))
